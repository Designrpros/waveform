      ...
      <Container>
        ...
        <FAQContainer>
          ...
          <FAQItem
            ...
            answer="WaveForm is a native music player application designed for Apple platforms (iOS, macOS, and visionOS) that lets you stream and manage music. It offers dynamic waveform visualization, extensive content discovery, and personalized playback features."
          />
          <FAQItem
          ...
          <FAQItem
            ...
            answer="You can discover music through the powerful search bar, exploring trending charts, browse top genres and artists, or create personalized radio stations based on any song within the app."
          />
          <FAQItem
